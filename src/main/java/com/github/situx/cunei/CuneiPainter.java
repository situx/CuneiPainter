...
public class CuneiPainter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statusText = (TextView)findViewById(R.id.startView);
        this.mv = (DrawingCanvas)findViewById(R.id.imageView);
        this.resultList = (ListView) findViewById(R.id.groupListView);
        try {
